package com.hyxiao.o2ostore.common;

import com.hyxiao.o2ostore.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.hyxiao.o2ostore.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
